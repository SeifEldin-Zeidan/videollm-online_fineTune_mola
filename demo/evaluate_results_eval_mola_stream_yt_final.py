...
def eval_results(results_list: list[dict]):
    ...
    for result in tqdm(results_list):
        ...
        if isVideoViolent != found_violence_detected:
            vType = "NONVIOLENT" if isVideoViolent == False else "VIOLENT"
            print(f"{vType}/{videoName}")
...
if __name__ == "__main__":
    ...
    anno_path_root = "/home/zeidan/Masters/videollm-online_fineTune_mola/demo/eval_mola_stream_results/train_incNvSegment"
    ...
    for root,dirs,files in os.walk(anno_path_root):
        ...
        for filename in files:
            if filename.endswith(".jsonl"):
                ...
                if yt_test:
                    anno_path_testSet = "/home/zeidan/Masters/yt_video_updated/violent/final/yt_video_violent_annotations_combined_vLLM.json"
